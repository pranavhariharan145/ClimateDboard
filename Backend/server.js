...
const axios = require('axios'); // If you want to use Axios, otherwise continue with node-fetch
...
app.get('/api/news', async (req, res) => {
    const newsApiKey = process.env.NEWS_API_KEY; // Get your News API key from environment variables
    const query = 'weather'; // We will query news related to weather

    const apiUrl = `https://newsapi.org/v2/everything?q=${query}&apiKey=${newsApiKey}&language=en&sortBy=publishedAt`;
